...
NODE137 = ""  # 不再硬编码本机 node 路径;用 CASTALIA_NODE 或 PATH 里的 node  # better-sqlite3/sqlite-vec 按 NODE_MODULE_VERSION 137 编译
# node 版本必须与 better-sqlite3 的编译版本一致(ABI 不匹配会直接崩溃)。
